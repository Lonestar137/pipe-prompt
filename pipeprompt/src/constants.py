...
Testing commands
    ls command @#cmd: dir #@
    hello_world@#cmd: testing command3#@
    hello_world@#cmd: testing command4#@
    hello_world@#cmd: testing command5#@
    hello_world@#cmd: testing command6#@
    hello_world@#cmd: testing command8#@
    hello_world@#cmd: testing command9#@
Testing commands 2 
    echo @#cmd: echo 'hello world'#@
    hello_world@#cmd: testing command11 {row_data}#@
    hello_world@#cmd: testing command12 {row_data}#@
    hello_world@#cmd: testing command13 {row_data}#@
    hello_world@#cmd: testing command14 {row_data}#@
    hello_world@#cmd: testing command15 {row_data}#@
    hello_world@#cmd: testing command16 {row_data}#@
    hello_world@#cmd: testing command17 #@
    hello_world@#cmd: testing command18 {row_data}#@
The Lorem ipsum text is derived from sections 1.10.32 and 1.10.33 of Cicero's 'De finibus bonorum et malorum'.
[7][8] The physical source may have been the 1914 Loeb Classical Library edition of De finibus, where the Latin text, presented on the left-hand (even) pages, breaks off on page 34 with "Neque porro quisquam est qui do-" and continues on page 36 with "lorem ipsum ...", suggesting that the galley type of that page was mixed up to make the dummy text seen today.
...
[2] McClintock first published his discovery in a 1994 letter to the editor of Before & After magazine, contesting the editor's earlier claim that Lorem ipsum held no meaning.[2]
...
Ut enim ad minima veniam, quis nostrum[d] exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? [D]Quis autem vel eum i[r]ure reprehenderit, qui in ea voluptate velit esse, quam nihil molestiae consequatur, vel illum, qui dolorem eum fugiat, quo voluptas nulla pariatur? [33] At vero eos et accusamus et iusto odio dignissimos ducimus, qui blanditiis praesentium voluptatum deleniti atque corrupti, quos dolores et quas molestias excepturi sint, obcaecati cupiditate non provident, similique sunt in culpa, qui officia deserunt mollitia animi, id est laborum et dolorum fuga.
...
In a free hour, when our power of choice is untrammeled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided.
But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently occur that pleasures have to be repudiated and annoyances accepted.
hello_world@#cmd: testing command1 #@
hello_world@#cmd: testing command2{row_data}#@
hello_world@#cmd: testing command3#@
hello_world@#cmd: testing command4#@
hello_world@#cmd: testing command5#@
hello_world@#cmd: testing command6#@
hello_world@#cmd: testing command8#@
hello_world@#cmd: testing command9#@
hello_world@#cmd: testing command10#@
hello_world@#cmd: testing command11 {row_data}#@
hello_world@#cmd: testing command12 {row_data}#@
hello_world@#cmd: testing command13 {row_data}#@
hello_world@#cmd: testing command14 {row_data}#@
